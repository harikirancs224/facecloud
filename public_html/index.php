...
<!--  <script src="//angular-ui.github.io/bootstrap/ui-bootstrap-tpls-0.13.4.js"></script>-->
  ...
  <script src="app/app.js?v112"></script>
  <script src="app/data.js?v112"></script>
  <script src="app/directives.js?v112"></script>
  <script src="app/headerCtrl.js?v112"></script>
  <script src="app/authCtrl.js?v112"></script>
  <script src="app/secCtrl.js?v112"></script>
  <script src="app/fileCtrl.js?v112"></script>
  <script src="app/accountCtrl.js?v112"></script>
